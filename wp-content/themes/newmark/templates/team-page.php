	...
	<div class="col-md-12">
		...
		<div class="filters">
			<div class="btn-group" data-filter-group="region">
				...
				<button class="btn region" data-filter=".nor_cal">Northern California</button>
				<button class="btn region" data-filter=".so_cal">Southern California</button>
				<button class="btn region" data-filter=".pac_nw">Pacific Northwest</button>
