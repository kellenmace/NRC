<?php
/**
 * Template Name: Storage Template
 */
?>
...
<div class="row">
<div class="grid">
	<?php $loop = new WP_Query( array( 'post_type' => 'transaction', 'posts_per_page' => -1, 'meta_query' => array( array('key' => 'storage_display', 'value' => '1', 'compare' => '==')))); ?>
