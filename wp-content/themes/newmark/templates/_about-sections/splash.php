<div class="row">
	<div class="col-md-12">
		...
		<div id="splash" class="splash-section" style="background-image: url(<?php the_post_thumbnail_url(); ?>);">
			<div class="row">
				<div class="photo-caption">
					<div class="col-sm-offset-1 col-sm-8">
							<a href="<?php the_permalink(); ?>">
								...
								?>
								<p><?php the_title(); ?> | <?php the_field('city', $query->ID); ?>, <?php echo $state_label; ?></p>
							</a>
					</div>
				</div>
			</div>
